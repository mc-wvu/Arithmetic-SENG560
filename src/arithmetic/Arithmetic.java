...
public class Arithmetic implements Adder, Subtractor, Multiplier, Divider {
    ...
    public String addBinary (String num1, String num2){
        return new Addition().addBinary(num1, num2);
    }
    public String addHex (String num1, String num2){
        return new Addition().addHex(num1, num2);
    }
    ...
    public String subtractBinary (String num1, String num2){
        return new Subtraction().subtractBinary(num1, num2);
    }
    public String subtractHex (String num1, String num2){
        return new Subtraction().subtractHex(num1, num2);
    }
    ...
    public String multiplyBinary (String num1, String num2){
        return new Multiplication().multiplyBinary(num1, num2);
    }
    public String multiplyHex (String num1, String num2){
        return new Multiplication().multiplyHex(num1, num2);
    }
    ...
    public String divideBinary (String num1, String num2){
        return new Division().divideBinary(num1, num2);
    }
    public String divideHex (String num1, String num2){
        return new Division().divideHex(num1, num2);
    }
}
